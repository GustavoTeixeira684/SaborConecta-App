...
class MenuPedidosAdapterAtivos(private val menuList: MutableList<MenuPedidos>, private val callingActivity: Activity) :
    RecyclerView.Adapter<MenuPedidosAdapterAtivos.MenuViewHolder>() {
